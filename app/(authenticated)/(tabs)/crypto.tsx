  ...
  return (
    ...
    >
      ...
      {currencies.data?.map((currency: Cryptocurrency) => (
        ...
        <TouchableOpacity style={{flexDirection: 'row', gap: 14, alignItems: 'center'}} key={currency.id}>
            ...
            <View style={{ gap: 6, alignItems: 'flex-end'}}>
              ...
              <View style={{flexDirection: 'row',gap: 4}}>
                <Ionicons 
                name={currency.quote.EUR.percent_change_1h > 0 ? 'caret-up' : 'caret-down'} size={16} 
                color={currency.quote.EUR.percent_change_1h > 0 ? 'green' : 'red'}/>
                <Text
                  style={{color: currency.quote.EUR.percent_change_1h > 0 ? 'green' : 'red'}}
                >{currency.quote.EUR.percent_change_1h.toFixed(2)}</Text>
              </View>
            </View>
